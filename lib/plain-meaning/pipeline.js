...
export function runPipeline(rawText, context = {}) {
  ...
  // Only strip after start of text or a period. A marker after a semicolon
  // or colon opens a new list item within what splitSentences still treats
  // as one sentence — stripping it there would delete text that anchorText
  // doesn't get re-split on, breaking its literal match against the source.
  text = text
