#!/usr/bin/env node
// Regression suite for colon-lettered-list item binding — confirms real
// bills that previously lost list items entirely (some producing zero units
// for the whole section) now preserve every item's content, and confirms
// the already-working MIXED/EACH-ITEM-OWN-FORCE/SHARED-DUTY shapes and the
// NOT-A-LIST gate (Defect 2) are unaffected.
// Usage: node scripts/test-colon-list-binding.js
...
const CASES_PATH = path.join(__dirname, "../data/wa/colon-list-binding-test-cases.json");
